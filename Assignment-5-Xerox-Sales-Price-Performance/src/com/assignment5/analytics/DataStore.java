...
public class DataStore {
    ...
    private Map<Integer, SalesPerson> salesPerson;
       private Map<Integer, Double> targetPrice;

    public Map<Integer, Double> getTargetPrice() {
        return targetPrice;
    }

    public void setTargetPrice(Map<Integer, Double> targetPrice) {
